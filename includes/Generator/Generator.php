...
abstract class Generator {
	...
	/**
	 * Meta key used to mark an object as created by this plugin, so it can be found and
	 * bulk-deleted later without touching real store data.
	 */
	const GENERATED_META_KEY = '_smoothgenerator_generated';
	...
	/**
	 * Meta query args to find objects marked as generated by this plugin.
	 *
	 * @return array
	 */
	protected static function generated_meta_query() {
		return array(
			array(
				'key'     => static::GENERATED_META_KEY,
				'compare' => 'EXISTS',
			),
		);
	}
